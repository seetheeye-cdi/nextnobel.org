...
const STORIES = [
  { id: 1, category: "Entomology", title: "맥주 찌꺼기로 해충을 잡는 과학자", author: "윤준호", affiliation: "서울대 농생명과학부 · 곤충화학생태학", excerpt: "26살에 서울대 박사를 수석 졸업하고, 13편의 논문을 쓴 곤충학자. 맥주 양조 부산물인 홉 찌꺼기에서 해충 방제의 실마리를 찾아냈다. 올 4월, 스웨덴으로 떠난다.", date: "2026.03.04", readTime: "15min" },
