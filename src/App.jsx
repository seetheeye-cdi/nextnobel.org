...
const STORIES = [
  { id: 1, category: "Entomology", title: "지속가능한 살충제를 설계하는 과학자", author: "윤준호", affiliation: "서울대 응용생물화학부 · 곤충 독성학", excerpt: "25살에 서울대 박사를 수석 졸업한 곤충학자. 살충제 혼합물 속 성분들이 만들어내는 복잡한 상호작용을 수학적으로 모델링하며, 더 정밀한 방제 전략을 설계한다. 올 4월, 스웨덴 룬드대학교에서 화분매개 곤충을 보전하는 연구를 시작한다.", date: "2026.03.04", readTime: "15min" },
    ...
    <section id="stories" style={{ maxWidth: 1080, margin: "0 auto", padding: "0 24px 72px" }}>
      <Reveal>
        <article onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} style={{ cursor: "pointer" }}>
          ...
          <p style={{ fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 15, color: "#888", lineHeight: 1.65, maxWidth: 520, marginBottom: 20 }}>{story.excerpt}</p>
