...
const STORIES = [
  { id: 1, category: "Entomology", title: "식물로 해충을 잡는 과학자", author: "윤준호", affiliation: "서울대 응용생물화학부 · 곤충 독성학", excerpt: "26살에 서울대 박사를 수석 졸업한 곤충학자. 로즈마리 에센셜 오일의 조성을 최적화해, 해충은 잡으면서 생태계는 해치지 않는 친환경 농약을 설계한다. 올 4월, 스웨덴 룬드대학교로 떠난다.", date: "2026.03.04", readTime: "15min" },
