...
const STORIES = [
  { id: 1, category: "Entomology", title: "해충의 약점을 파고드는 독성학자", author: "윤준호", affiliation: "서울대 응용생물화학부 · 곤충 독성학", excerpt: "26살에 서울대 박사를 수석 졸업한 곤충학자. 해충이 살충제에 어떻게 저항하는지를 분자 수준에서 파헤치며, 더 정밀한 방제 전략을 설계한다. 올 4월, 스웨덴 룬드대학교로 떠난다.", date: "2026.03.04", readTime: "15min" },
